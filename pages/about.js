const about = () => {
  return (
    <div class='mx-auto sm:text-lg md:text-3xl lg:text-3xl text-white font-bold mt-20  text-center  py-5 bg-gradient-to-b from-orange-400 via-green-700 to-zinc-500 h-screen rounded-full'>
