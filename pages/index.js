...
const Home = () =>{
  ...
  <div class='grid h-screen w-screen'>
    ...
    <div class='columns-1 text-center bg-gradient-to-r from-red-500 via-black to-red-600'>
      ...
      <img src={'/assets/christmas-gc85cc9870_1920.jpg'} class='h-96 w-screen md:w-screen lg:w-screen'></img>
      ...
      <img src={'/assets/Screenshot 2022-12-13 133913.png'} class='content-start sm:h-screen sm:w-full'></img>
      ...
      <img src={'/assets/nodejs.png'} class='sm:h-screen sm:w-screen'></img>
